...
model2 <- train(classe~.,data=trainData,method="ctree", preProcess="pca")
...
table(trainData$classe,predict(model2,newdata=trainData))
table(validData$classe,predict(model2,newdata=validData))
